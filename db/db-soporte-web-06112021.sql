...
--
-- Servidor: localhost
-- Tiempo de generación: 06-11-2021 a las 13:44:09
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `ACTUALIZAR_CONTRASEÑA`(IN `_id_usuario` INT(11), IN `_nclave` TEXT)
BEGIN
UPDATE ws_usuarios set clave = _nclave where id_usuario = _id_usuario;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `ACTUALIZAR_EQUIPOC`(IN `_idEquipo` INT(11), IN `_idTipo` INT(11), IN `_uResponsable` INT(11), IN `_office` INT(11), IN `_service` INT(11), IN `_serie` TEXT, IN `_sbn` TEXT, IN `_marca` TEXT, IN `_modelo` TEXT, IN `_descripcion` TEXT, IN `_fechaCompra` DATE, IN `_ordenCompra` TEXT, IN `_garantia` TEXT, IN `_placa` TEXT, IN `_procesador` TEXT, IN `_vprocesador` TEXT, IN `_ram` TEXT, IN `_discoDuro` TEXT, IN `_condicion` INT(11), IN `_estadoEQ` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ACTUALIZAR_EQUIPOP`(IN `_idEquipo` INT(11), IN `_idTipo` INT(11), IN `_uResponsable` INT(11), IN `_office` INT(11), IN `_service` INT(11), IN `_serie` TEXT, IN `_sbn` TEXT, IN `_marca` TEXT, IN `_modelo` TEXT, IN `_descripcion` TEXT, IN `_fechaCompra` DATE, IN `_ordenCompra` TEXT, IN `_garantia` TEXT, IN `_condicion` INT(11), IN `_estadoEQ` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ACTUALIZAR_EQUIPOR`(IN `_idEquipo` INT(11), IN `_idTipo` INT(11), IN `_uResponsable` INT(11), IN `_office` INT(11), IN `_service` INT(11), IN `_serie` TEXT, IN `_sbn` TEXT, IN `_marca` TEXT, IN `_modelo` TEXT, IN `_descripcion` TEXT, IN `_fechaCompra` DATE, IN `_ordenCompra` TEXT, IN `_garantia` TEXT, IN `_puertos` TEXT, IN `_capa` TEXT, IN `_condicion` INT(11), IN `_estadoEQ` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ACTUALIZAR_ESTADO_REPO`(IN `_idEquipo` INT(11), IN `_observaciones` TEXT, IN `_estadoEQ` INT(11))
UPDATE ws_equipos set observaciones= _observaciones,estadoEQ = _estadoEQ where idEquipo = _idEquipo$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `ACTUALIZAR_RESPONSABLE`(IN `_dniResp` TEXT, IN `_nombresResp` TEXT, IN `_apellidosResp` TEXT, IN `_idOficina` INT(11), IN `_idServicio` INT(11), IN `_idResponsable` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ANULAR_INTEGRACION`(IN `_idIntegracion` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ANULAR_MANTENIMIENTO`(IN `_idMantenimiento` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ANULAR_REPOSICION`(IN `_idReposicion` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `DESBLOQUEAR_USUARIO`(IN `_id_usuario` INT(11))
BEGIN
UPDATE ws_usuarios set nintentos = 0 where id_usuario = _id_usuario;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `EDITAR_CATEGORIA`(IN `_idCategoria` INT(11), IN `_categoria` TEXT, IN `_segmento` INT(11))
BEGIN
UPDATE ws_categorias SET categoria = _categoria, segmento = _segmento WHERE idCategoria = _idCategoria;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `EDITAR_INTEGRACIONC`(IN `_idIntegracion` INT(11), IN `_nro_eq` TEXT, IN `_ip` TEXT, IN `_serie_pc` INT(11), IN `_serie_monitor` INT(11), IN `_serie_teclado` INT(11), IN `_serie_EstAcu` INT(11), IN `_tipo_equipo` INT(11), IN `_responsable` INT(11), IN `_oficina_in` INT(11), IN `_servicio_in` INT(11), IN `_estado` INT(11), IN `_condicion` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `EDITAR_INTEGRACIONC1`(IN `_idIntegracion` INT(11), IN `_nro_eq` TEXT, IN `_ip` TEXT, IN `_serie_pc` INT(11), IN `_tipo_equipo` INT(11), IN `_responsable` INT(11), IN `_oficina_in` INT(11), IN `_servicio_in` INT(11), IN `_estado` INT(11), IN `_condicion` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `EDITAR_INTEGRACIONI`(IN `_idIntegracion` INT(11), IN `_nro_eq` TEXT, IN `_ip` TEXT, IN `_serie_imp` INT(11), IN `_tipo_equipo` INT(11), IN `_responsable` INT(11), IN `_oficina_in` INT(11), IN `_servicio_in` INT(11), IN `_estado` INT(11), IN `_condicion` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `EDITAR_INTEGRACIONR`(IN `_idIntegracion` INT(11), IN `_nro_eq` TEXT, IN `_ip` TEXT, IN `_serie_eqred` INT(11), IN `_tipo_equipo` INT(11), IN `_responsable` INT(11), IN `_oficina_in` INT(11), IN `_servicio_in` INT(11), IN `_estado` INT(11), IN `_condicion` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `EDITAR_MANTENIMIENTO`(IN `_idMantenimiento` INT(11), IN `_tipEquipo` INT(11), IN `_condInicial` INT(11), IN `_idEquip` INT(11), IN `_oficEquip` INT(11), IN `_areaEquip` INT(11), IN `_respoEquip` INT(11), IN `_logdeta` TEXT, IN `_descInc` TEXT, IN `_tecEvalua` INT(11), IN `_diagnostico1` INT(11), IN `_diagnostico2` INT(11), IN `_diagnostico3` INT(11), IN `_diagnostico4` INT(11), IN `_diagnostico5` INT(11), IN `_diagnostico6` INT(11), IN `_diagnostico7` INT(11), IN `_diagnostico8` INT(11), IN `_fEvalua` DATE, IN `_primera_eval` TEXT, IN `_fInicio` DATE, IN `_fFin` DATE, IN `_tipTrabajo` INT(11), IN `_tecResp` INT(11), IN `_accion1` INT(11), IN `_accion2` INT(11), IN `_accion3` INT(11), IN `_accion4` INT(11), IN `_accion5` INT(11), IN `_accion6` INT(11), IN `_accion7` INT(11), IN `_accion8` INT(11), IN `_recomendaciones` TEXT, IN `_estAtencion` INT(11), IN `_condFinal` INT(11), IN `_servTerce` TEXT, IN `_otros` TEXT, IN `_obsOtros` TEXT, IN `_sgmtoManto` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `EDITAR_OFICINA_DPTO`(IN `_id_area` INT(11), IN `_area` TEXT)
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `EDITAR_SERVICIO_OD`(IN `_id_area` INT(11), IN `_id_subarea` INT(11), IN `_subarea` TEXT)
BEGIN
UPDATE ws_servicios SET subarea = _subarea, id_area = _id_area WHERE id_subarea = _id_subarea;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `ELIMINAR_CATEGORIA`(IN `_idCategoria` INT(11))
BEGIN
DELETE FROM ws_categorias WHERE idCategoria = _idCategoria;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `ELIMINAR_EQREDES`(IN `_idEquipo` INT(11), OUT `nExistencia` INT(11))
BEGIN
    DECLARE conteo INT;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ELIMINAR_IMPRESORA_PERIFERICOS`(IN `_idEquipo` INT(11), IN `_idTipo` INT(11), OUT `nExistencia` INT(11))
BEGIN
DECLARE conteo INT;
DECLARE tipo int;
set tipo = _idTipo;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ELIMINAR_OFICINA_DPTO`(IN `_id_area` INT(11))
BEGIN
DELETE FROM ws_departamentos WHERE id_area = _id_area;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `ELIMINAR_PC_LAPTOP`(IN `_idEquipo` INT(11), OUT `nExistencia` INT(11))
BEGIN
    DECLARE conteo INT;
	SET conteo = (SELECT count(idEquipo) as existencia FROM ws_equipos eq
	WHERE EXISTS (SELECT NULL
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ELIMINAR_RESPONSABLE`(IN `_id` INT(11))
BEGIN
DELETE FROM ws_responsables WHERE idResponsable = _id;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `ELIMINAR_SERVICIO_OD`(IN `_id_subarea` INT(11))
BEGIN
DELETE FROM ws_servicios WHERE id_subarea = _id_subarea;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `INTENTOS_USUARIO`(IN `_id_usuario` INT(11))
BEGIN
UPDATE ws_usuarios set nintentos = nintentos + 1 where id_usuario = _id_usuario;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTADO_USUARIOS_SISTEMA`()
SELECT id_usuario,usuario.id_perfil,perfil,dni,nombres,apellido_paterno,apellido_materno,cuenta,clave,date_format(fecha_registro,'%d-%m-%Y') as fecha_registro,estado FROM ws_usuarios as usuario inner join ws_perfiles as perf on usuario.id_perfil = perf.id_perfil$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_ACCIONES`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_ACCI_SEGMENTO`(IN `_idSegmento` INT(11))
BEGIN
select idAccion,accionrealizada,segment from ws_acciones where segment = _idSegmento order by accionrealizada;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_AREAS_SERV`()
SELECT
	id_subarea,
	subarea,
	serv.id_area,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_CATEGORIASC`()
BEGIN
SELECT * FROM ws_categorias where segmento = 1;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_CATEGORIASP`()
BEGIN
SELECT * FROM ws_categorias where segmento = 3;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_CATEGORIASP2`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_CATEGORIASR`()
BEGIN
SELECT * FROM ws_categorias where segmento = 2;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_CONDICIONMANTO`()
BEGIN
select * from ws_situacion where idSituacion between 1 and 2;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_DATOS_EQCOMPUTO`(IN `_idEquipo` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_DATOS_EQIMP_OTROS`(IN `_idEquipo` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_DATOS_EQOTROS`(IN `_idEquipo` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_DATOS_EQREDES`(IN `_idEquipo` INT(11))
BEGIN
SELECT idEquipo,tipSegmento,descSegmento,uResponsable,UPPER(nombresResp) AS nombresResp,UPPER(apellidosResp) AS apellidosResp,office,area,service,subarea,nro_eq,serie,sbn,ip,marca,modelo,descripcion FROM ws_equipos eqp
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_DIAG_SEGMENTO`(IN `_idSegmento` INT(11))
BEGIN
select idDiagnostico,diagnostico,sgmto from ws_diagnosticos where sgmto = _idSegmento order by diagnostico;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_EQUIPOSC`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_EQUIPOSP`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_EQUIPOSR`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_EQUPOSCOMPUTOMANT`(IN `_idTipo` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_EQUPOSIMPREMANT`(IN `_idTipo` INT(11))
BEGIN
SELECT idEquipo,serie FROM ws_equipos WHERE idTipo = _idTipo;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_EQUPOSOTROS`(IN `_idTipo` INT(11))
BEGIN
select idEquipo,serie from ws_equipos where idTipo = _idTipo;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_EQUPOSREDMANT`(IN `_idTipo` INT(11))
BEGIN
SELECT idEquipo,serie FROM ws_equipos eq 
	WHERE idTipo = _idTipo;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_ESTATENCION`()
BEGIN
SELECT idEstAte,estAte FROM ws_estadoatencion;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_FICHAS_MANTO`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_FICHAS_REPO`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_INTEGRACIONC`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_INTEGRACIONI`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_INTEGRACIONR`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_MANTO_COMPUS`(IN `_idMantenimiento` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_MANTO_COMPUS_REPO`(IN `_idReposicion` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_MANTO_IMPRE_PERI`(IN `_idMantenimiento` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_MANTO_IMPRE_PERI_REPO`(IN `_idReposicion` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_MANTO_OTROS`(IN `_idMantenimiento` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_MANTO_OTROS_REPO`(IN `_idReposicion` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_MANTO_REDES`(IN `_idMantenimiento` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_MANTO_REDES_REPO`(IN `_idReposicion` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_OFICINAS`()
SELECT * FROM ws_departamentos  ORDER BY area asc$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_RESPONSABLES`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_RESPONSABLES_ITEM`(IN `_campo` TEXT, IN `_valor` TEXT)
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_SERIESENER`()
BEGIN
SELECT idEquipo,serie FROM ws_equipos eq
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_SERIESIMP`()
BEGIN
SELECT idEquipo,serie FROM ws_equipos eq
WHERE NOT EXISTS (SELECT NULL
FROM ws_integraciones eimp
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_SERIESLAPSERV`()
BEGIN
SELECT idEquipo,serie FROM ws_equipos eq
WHERE NOT EXISTS (SELECT NULL
FROM ws_integraciones epc
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_SERIESMON`()
BEGIN
SELECT idEquipo,serie FROM ws_equipos eq
WHERE NOT EXISTS (SELECT NULL
FROM ws_integraciones epc
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_SERIESPC`()
BEGIN
SELECT idEquipo,serie FROM ws_equipos eq
WHERE NOT EXISTS (SELECT NULL
FROM ws_integraciones epc
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_SERIESRED`()
BEGIN
SELECT idEquipo,serie FROM ws_equipos eq
WHERE NOT EXISTS (SELECT NULL
FROM ws_integraciones epc
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_SERIESTEC`()
BEGIN
SELECT idEquipo,serie FROM ws_equipos eq
WHERE NOT EXISTS (SELECT NULL
FROM ws_integraciones epc
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_SERVICIOS`(IN `_id_area` INT)
BEGIN
	SELECT * FROM ws_servicios WHERE id_area = _id_area;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_TRABAJOSMANTO`()
BEGIN
SELECT * FROM ws_tipotrabajo where idTipoTrabajo between 1 and 3;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_UTECNICOS`()
BEGIN
select id_usuario,nombres,apellido_paterno,apellido_materno from ws_usuarios where id_perfil between 3 and 4;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTA_SACCI1`(IN `_sgmt` INT(11), IN `_existe` INT(11))
BEGIN
SELECT idAccion,accionrealizada FROM ws_acciones where segment = _sgmt and  idAccion != _existe order by accionrealizada;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTA_SACCI2`(IN `_sgmt` INT(11), IN `_existe` INT(11), IN `_existe2` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTA_SACCI3`(IN `_sgmt` INT(11), IN `_existe` INT(11), IN `_existe2` INT(11), IN `_existe3` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTA_SACCI4`(IN `_sgmt` INT(11), IN `_existe` INT(11), IN `_existe2` INT(11), IN `_existe3` INT(11), IN `_existe4` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTA_SACCI5`(IN `_sgmt` INT(11), IN `_existe` INT(11), IN `_existe2` INT(11), IN `_existe3` INT(11), IN `_existe4` INT(11), IN `_existe5` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTA_SACCI6`(IN `_sgmt` INT(11), IN `_existe` INT(11), IN `_existe2` INT(11), IN `_existe3` INT(11), IN `_existe4` INT(11), IN `_existe5` INT(11), IN `_existe6` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTA_SACCI7`(IN `_sgmt` INT(11), IN `_existe` INT(11), IN `_existe2` INT(11), IN `_existe3` INT(11), IN `_existe4` INT(11), IN `_existe5` INT(11), IN `_existe6` INT(11), IN `_existe7` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTA_SDIAG`(IN `_sgmt` INT(11), IN `_existe` INT(11))
BEGIN
SELECT idDiagnostico,diagnostico FROM ws_diagnosticos where sgmto = _sgmt and  idDiagnostico != _existe order by diagnostico;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTA_SDIAG2`(IN `_sgmt` INT(11), IN `_existe` INT(11), IN `_existe2` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTA_SDIAG3`(IN `_sgmt` INT(11), IN `_existe` INT(11), IN `_existe2` INT(11), IN `_existe3` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTA_SDIAG4`(IN `_sgmt` INT(11), IN `_existe` INT(11), IN `_existe2` INT(11), IN `_existe3` INT(11), IN `_existe4` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTA_SDIAG5`(IN `_sgmt` INT(11), IN `_existe` INT(11), IN `_existe2` INT(11), IN `_existe3` INT(11), IN `_existe4` INT(11), IN `_existe5` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTA_SDIAG6`(IN `_sgmt` INT(11), IN `_existe` INT(11), IN `_existe2` INT(11), IN `_existe3` INT(11), IN `_existe4` INT(11), IN `_existe5` INT(11), IN `_existe6` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTA_SDIAG7`(IN `_sgmt` INT(11), IN `_existe` INT(11), IN `_existe2` INT(11), IN `_existe3` INT(11), IN `_existe4` INT(11), IN `_existe5` INT(11), IN `_existe6` INT(11), IN `_existe7` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LOGIN_USUARIO`(IN `_cuenta` TEXT)
BEGIN
select * from ws_usuarios where cuenta= _cuenta;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_CATEGORIA`(IN `_categoria` TEXT, IN `_segmento` INT(11))
BEGIN
INSERT INTO ws_categorias(categoria,segmento) VALUES(_categoria,_segmento);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_EQUIPOC`(IN `_idTipo` INT(11), IN `_uResponsable` INT(11), IN `_idOficina` INT(11), IN `_idServicio` INT(11), IN `_serie` TEXT, IN `_sbn` TEXT, IN `_marca` TEXT, IN `_modelo` TEXT, IN `_descripcion` TEXT, IN `_fechaCompra` DATE, IN `_ordenCompra` TEXT, IN `_garantia` TEXT, IN `_placa` TEXT, IN `_procesador` TEXT, IN `_vprocesador` TEXT, IN `_ram` TEXT, IN `_discoDuro` TEXT, IN `_observaciones` TEXT, IN `_condicion` INT(11), IN `_estadoEQ` INT(11), IN `_registrador` INT(11), IN `_tipSegmento` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_EQUIPOP`(IN `_idTipo` INT(11), IN `_uResponsable` INT(11), IN `_idOficina` INT(11), IN `_idServicio` INT(11), IN `_serie` TEXT, IN `_sbn` TEXT, IN `_marca` TEXT, IN `_modelo` TEXT, IN `_descripcion` TEXT, IN `_fechaCompra` TEXT, IN `_ordenCompra` TEXT, IN `_garantia` TEXT, IN `_observaciones` TEXT, IN `_condicion` INT(11), IN `_estadoEQ` INT(11), IN `_registrador` INT(11), IN `_tipSegmento` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_EQUIPOR`(IN `_idTipo` INT(11), IN `_uResponsable` INT(11), IN `_idOficina` INT(11), IN `_idServicio` INT(11), IN `_serie` TEXT, IN `_sbn` TEXT, IN `_marca` TEXT, IN `_modelo` TEXT, IN `_descripcion` TEXT, IN `_fechaCompra` TEXT, IN `_ordenCompra` TEXT, IN `_garantia` TEXT, IN `_puertos` TEXT, IN `_capa` TEXT, IN `_observaciones` TEXT, IN `_condicion` INT(11), IN `_estadoEQ` INT(11), IN `_registrador` INT(11), IN `_tipSegmento` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_INTEGRACIONC`(IN `_nro_eq` TEXT, IN `_ip` TEXT, IN `_serie_pc` INT(11), IN `_serie_monitor` INT(11), IN `_serie_teclado` INT(11), IN `_serie_EstAcu` INT(11), IN `_fecha_registro` DATE, IN `_tipo_equipo` INT(11), IN `_responsable` INT(11), IN `_oficina_in` INT(11), IN `_servicio_in` INT(11), IN `_estado` INT(11), IN `_condicion` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_INTEGRACIONC1`(IN `_nro_eq` TEXT, IN `_ip` TEXT, IN `_serie_pc` INT(11), IN `_fecha_registro` DATE, IN `_tipo_equipo` INT(11), IN `_responsable` INT(11), IN `_oficina_in` INT(11), IN `_servicio_in` INT(11), IN `_estado` INT(11), IN `_condicion` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_INTEGRACIONCER`(IN `_nro_eq` TEXT, IN `_ip` TEXT, IN `_serie_eqred` INT(11), IN `_fecha_registro` DATE, IN `_tipo_equipo` INT(11), IN `_responsable` INT(11), IN `_oficina_in` INT(11), IN `_servicio_in` INT(11), IN `_estado` INT(11), IN `_condicion` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_INTEGRACIONCI`(IN `_nro_eq` TEXT, IN `_ip` TEXT, IN `_serie_imp` INT(11), IN `_fecha_registro` DATE, IN `_tipo_equipo` INT(11), IN `_responsable` INT(11), IN `_oficina_in` INT(11), IN `_servicio_in` INT(11), IN `_estado` INT(11), IN `_condicion` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_OFICINA_DPTO`(IN `_area` TEXT)
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_RESPONSABLE`(IN `_dniResp` TEXT, IN `_nombresResp` TEXT, IN `_apellidosResp` TEXT, IN `_idOficina` INT(11), IN `_idServicio` INT(11))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_SERVICIO_OD`(IN `_id_area` INT(11), IN `_subarea` TEXT)
BEGIN
INSERT INTO ws_servicios(id_area, subarea) VALUES(_id_area,_subarea);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRO_USUARIO`(IN `_perfil` INT(11), IN `_dni` VARCHAR(8), IN `_nombres` TEXT, IN `_apellidoPat` TEXT, IN `_apellidoMat` TEXT, IN `_cuenta` TEXT, IN `_clave` TEXT)
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `Z_REG_AUDITORIAMANT`(IN `_idDoc` INT(11), IN `_usExec` INT(11), IN `_accExec` TEXT, IN `_fecha_audi` DATE)
BEGIN
INSERT INTO ws_z_auditoria_mantenimientos(idDoc,usExec,accExec,fecha_audi) VALUES(_idDoc,_usExec,_accExec,_fecha_audi);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `Z_REG_AUDITORIAREPO`(IN `_idDoc` INT(11), IN `_usExec` INT(11), IN `_accExec` TEXT, IN `_fecha_audi` DATE)
BEGIN
...
-- Funciones
--
CREATE DEFINER=`root`@`localhost` FUNCTION `IFEMPTY`(`s` TEXT, `defaultValue` TEXT) RETURNS text CHARSET latin1
...
CREATE TABLE IF NOT EXISTS `ws_acciones` (
...
CREATE TABLE IF NOT EXISTS `ws_categorias` (
...
CREATE TABLE IF NOT EXISTS `ws_departamentos` (
...
CREATE TABLE IF NOT EXISTS `ws_diagnosticos` (
...
CREATE TABLE IF NOT EXISTS `ws_equipos` (
...
CREATE TABLE IF NOT EXISTS `ws_estado` (
...
CREATE TABLE IF NOT EXISTS `ws_estadoatencion` (
...
CREATE TABLE IF NOT EXISTS `ws_estadosdoc` (
...
CREATE TABLE IF NOT EXISTS `ws_integraciones` (
...
--
DELIMITER $$
CREATE TRIGGER `GENERAR_CORRELATIVO_INTEGRACION` BEFORE INSERT ON `ws_integraciones`
 FOR EACH ROW BEGIN
...
CREATE TABLE IF NOT EXISTS `ws_mantenimientos` (
...
(23, 'FM-2021-00023', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(24, 'FM-2021-00024', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(25, 'FM-2021-00025', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(26, 'FM-2021-00026', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(27, 'FM-2021-00027', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(28, 'FM-2021-00028', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(29, 'FM-2021-00029', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(30, 'FM-2021-00030', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(31, 'FM-2021-00031', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(32, 'FM-2021-00032', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(33, 'FM-2021-00033', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(34, 'FM-2021-00034', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(35, 'FM-2021-00035', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(36, 'FM-2021-00036', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(37, 'FM-2021-00037', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(38, 'FM-2021-00038', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(39, 'FM-2021-00039', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(40, 'FM-2021-00040', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(41, 'FM-2021-00041', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(42, 'FM-2021-00042', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(43, 'FM-2021-00043', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(44, 'FM-2021-00044', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(45, 'FM-2021-00045', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(46, 'FM-2021-00046', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(47, 'FM-2021-00047', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(48, 'FM-2021-00048', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(49, 'FM-2021-00049', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(50, 'FM-2021-00050', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(51, 'FM-2021-00051', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(52, 'FM-2021-00052', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(53, 'FM-2021-00053', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(54, 'FM-2021-00054', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(55, 'FM-2021-00055', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(56, 'FM-2021-00056', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(57, 'FM-2021-00057', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(58, 'FM-2021-00058', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(59, 'FM-2021-00059', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(60, 'FM-2021-00060', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(61, 'FM-2021-00061', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(62, 'FM-2021-00062', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(63, 'FM-2021-00063', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(64, 'FM-2021-00064', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(65, 'FM-2021-00065', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(66, 'FM-2021-00066', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(67, 'FM-2021-00067', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(68, 'FM-2021-00068', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(69, 'FM-2021-00069', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(70, 'FM-2021-00070', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(71, 'FM-2021-00071', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(72, 'FM-2021-00072', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(73, 'FM-2021-00073', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(74, 'FM-2021-00074', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(75, 'FM-2021-00075', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(76, 'FM-2021-00076', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(77, 'FM-2021-00077', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(78, 'FM-2021-00078', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(79, 'FM-2021-00079', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(80, 'FM-2021-00080', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(81, 'FM-2021-00081', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(82, 'FM-2021-00082', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(83, 'FM-2021-00083', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(84, 'FM-2021-00084', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(85, 'FM-2021-00085', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(86, 'FM-2021-00086', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(87, 'FM-2021-00087', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(88, 'FM-2021-00088', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(89, 'FM-2021-00089', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23'),
(90, 'FM-2021-00090', '2021-11-04', 1, 1, 1, 1, 1, 1, 'N° Equipo: PC_0744 || Serie N°: MXL4420TS6 || Cod.Patr: 740899500567 || Marca: HP || Modelo: ELITE DESK || Descripción: ESTACION DE TRABAJO || IP:  || Procesador: CORE I7-3.40 GHZ || RAM: 8GB || Disco Duro: 1TB', 'Asas', 9, 0, 0, 0, 0, 0, 0, 0, 5, '2021-11-02', 'Asasas', '2021-11-04', '2021-11-04', 2, 5, 28, 25, 1, 0, 0, 0, 0, 0, 'Asasasas', 1, 1, 'NO', 'SI', 'La xd', 1, 1, 1, '2021-11-05 20:15:23');

--
-- Disparadores `ws_mantenimientos`
--
DELIMITER $$
CREATE TRIGGER `GENERAR_CORRELATIVO_MANTENIMIENTO` BEFORE INSERT ON `ws_mantenimientos`
 FOR EACH ROW BEGIN
    DECLARE cont1 int default 0;
    DECLARE anio text;
    set anio = (SELECT YEAR(CURDATE()));
...
CREATE TABLE IF NOT EXISTS `ws_perfiles` (
...
CREATE TABLE IF NOT EXISTS `ws_reposiciones` (
...
--
DELIMITER $$
CREATE TRIGGER `GENERAR_CORRELATIVO_REPOSICION` BEFORE INSERT ON `ws_reposiciones`
 FOR EACH ROW BEGIN
    DECLARE cont1 int default 0;
    DECLARE anio text;
    set anio = (SELECT YEAR(CURDATE()));
...
CREATE TABLE IF NOT EXISTS `ws_responsables` (
...
CREATE TABLE IF NOT EXISTS `ws_segmento` (
...
CREATE TABLE IF NOT EXISTS `ws_servicios` (
...
CREATE TABLE IF NOT EXISTS `ws_situacion` (
...
CREATE TABLE IF NOT EXISTS `ws_tipotrabajo` (
...
CREATE TABLE IF NOT EXISTS `ws_z_auditoria_mantenimientos` (
...
CREATE TABLE IF NOT EXISTS `ws_z_auditoria_reposiciones` (
...
--
ALTER TABLE `ws_integraciones`
  MODIFY `idIntegracion` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=26;
--
-- AUTO_INCREMENT de la tabla `ws_mantenimientos`
--
ALTER TABLE `ws_mantenimientos`
  MODIFY `idMantenimiento` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=91;
--
