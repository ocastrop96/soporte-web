...
--
-- Servidor: localhost
-- Tiempo de generación: 27-02-2022 a las 04:17:43
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `ANULAR_ATENCION`(IN `_idAtencion` INT(11))
UPDATE acpsy_atencion SET idEpisodio = "ANULADA", cuentaAtencion = "ANULADA", idEstadoAte = 2 WHERE idAtencion = _idAtencion$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `ANULAR_SEGUIMIENTO`(IN `_idSeguimiento` INT(11))
UPDATE acpsy_seguimiento 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `DESBLOQUEAR_USUARIO`(IN `_idUsuario` INT(11))
UPDATE acpsy_usuarios SET intentosUsuario = 0 WHERE idUsuario = _idUsuario$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `EDITAR_ATENCION`(IN `_idEpisodio` TEXT, IN `_cuentaAtencion` VARCHAR(20), IN `_historiaAtencion` VARCHAR(20), IN `_idEstadoPacAtencion` INT(11), IN `_fechaPacNacimiento` DATE, IN `_tipdocAtencion` VARCHAR(20), IN `_nrodocAtencion` VARCHAR(15), IN `_apPaternoAtencion` VARCHAR(30), IN `_apMaternoAtencion` VARCHAR(30), IN `_nombAtencion` VARCHAR(30), IN `_fIngresoAtencion` DATE, IN `_servAtencion` VARCHAR(100), IN `_camaAtencion` VARCHAR(20), IN `_distritoAtencion` VARCHAR(100), IN `_edadAtencion` VARCHAR(20), IN `_tipSexoAtencion` INT(11), IN `_financiaAtencion` VARCHAR(50), IN `_idAtencion` INT(11))
UPDATE acpsy_atencion SET idEpisodio = _idEpisodio,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `EDITAR_DIAGNOSTICO`(IN `_idDiagnostico` INT(11), IN `_cieDiagnostico` VARCHAR(20), IN `_detaDiagnostico` VARCHAR(100))
UPDATE acpsy_diagnosticos SET cieDiagnostico = _cieDiagnostico,detaDiagnostico = _detaDiagnostico WHERE idDiagnostico = _idDiagnostico$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `EDITAR_FAMILIARES`(IN `_idFamiliar` INT(11), IN `_idAtencion` INT(11), IN `_idParentesco` INT(11), IN `_idTipSexo` INT(11), IN `_tipdocFamiliar` VARCHAR(20), IN `_ndocFamiliar` VARCHAR(20), IN `_nombApFamiliar` VARCHAR(100), IN `_edadFamiliar` VARCHAR(20), IN `_telcelFamiliar` VARCHAR(12))
UPDATE acpsy_famatencion 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `EDITAR_PROFESIONAL`(IN `_idProfesional` INT(11), IN `_idCondicion` INT(11), `_dniProfesional` VARCHAR(15), IN `_cpspProfesional` VARCHAR(25), IN `_apellidosProfesional` VARCHAR(50), IN `_nombresProfesional` VARCHAR(50))
UPDATE acpsy_profesionales SET idCondicion = _idCondicion, dniProfesional = _dniProfesional, cpspProfesional = _cpspProfesional, apellidosProfesional = _apellidosProfesional, nombresProfesional = _nombresProfesional WHERE idProfesional = _idProfesional$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `EDITAR_SEGUIMIENTO`(IN `_idSeguimiento` INT(11), IN `_fRegistrSeg` DATE, IN `_idAtencionPac` INT(11), IN `_idProfesional` INT(11), IN `_idTipoSeguimiento` INT(11), IN `_idMotSeguimiento` INT(11), IN `_idDiag1Seg` INT(11), IN `_idDiag2Seg` INT(11), IN `_comunFamSeg` VARCHAR(10), IN `_idFamAtSeg` INT(11), IN `_idDiag1SegFam` INT(11), IN `_idDiag2SegFam` INT(11), IN `_obsSeg` VARCHAR(200))
UPDATE acpsy_seguimiento 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `EDITAR_USUARIO`(IN `_idUsuario` INT(11), IN `_idPerfil` INT(11), IN `_dniUsuario` VARCHAR(20), IN `_apellidosUsuario` VARCHAR(50), IN `_nombresUsuario` VARCHAR(50), IN `_cuentaUsuario` VARCHAR(50), IN `_correoUsuario` VARCHAR(50), IN `_claveUsuario` VARCHAR(100))
UPDATE acpsy_usuarios 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ELIMINAR_DIAGNOSTICO`(IN `_idDiagnostico` INT(11))
DELETE FROM acpsy_diagnosticos WHERE idDiagnostico = _idDiagnostico$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `ELIMINAR_FAMILIAR`(IN `_idFamiliar` INT(11), OUT `nExistencia` INT(11))
BEGIN
    DECLARE conteo INT;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ELIMINAR_PROFESIONAL`(IN `_idProfesional` INT(11))
DELETE FROM acpsy_profesionales WHERE idProfesional = _idProfesional$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `ELIMINAR_USUARIO`(IN `_idUsuario` INT(11))
DELETE FROM acpsy_usuarios WHERE idUsuario = _idUsuario$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `GRAFICO_DIAGNOSTICOS`()
SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GRAFICO_SEGUIMIENTO_MENSUAL`()
SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `HABILITAR_PROFESIONAL`(IN `_idProfesional` INT(11), IN `_idEstado` INT(11))
UPDATE acpsy_profesionales SET idEstado = _idEstado WHERE idProfesional = _idProfesional$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `HABILITAR_USUARIO`(IN `_idUsuario` INT(11), IN `_idEstado` INT(11))
UPDATE acpsy_usuarios SET idEstado = _idEstado WHERE idUsuario = _idUsuario$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_ATENCIONES`()
SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_ATENCIONES_F`()
SELECT
acpsy_atencion.idAtencion,
acpsy_atencion.correlativo_Atencion,
date_format( acpsy_atencion.fRegistroAtencion, '%d/%m/%Y' ) AS fRegistroAtencion,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_ATENCIONES_FECHAS`(IN `_fechaInicialAte` DATE, IN `_fechaFinalAte` DATE)
IF
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_CONDICIONES_PROF`()
SELECT idCondicion,detaCondicion FROM acpsy_condicionprof$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_DIAGNOSTICO_NO_SELECCIONADO`(IN `_idDiagnostico` INT)
SELECT
acpsy_diagnosticos.idDiagnostico,
acpsy_diagnosticos.cieDiagnostico,
UPPER(acpsy_diagnosticos.detaDiagnostico) AS detaDiagnostico
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_ESTADOS_PACIENTE`()
SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_ETAPAS_SEGUIMIENTO`()
SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_FAMILIARES`()
SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_FAMILIARES_F`()
SELECT
acpsy_famatencion.idFamiliar,
date_format( acpsy_famatencion.fechaRegistro, '%d/%m/%Y' ) AS fechaRegistro,
acpsy_famatencion.idAtencion,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_FAMILIARES_FECHAS`(IN `_fechaInicialFam` DATE, IN `_fechaFinalFam` DATE)
IF
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_FAMILIAR_PACIENTE`(IN `_idAtencion` INT(11))
SELECT
	acpsy_famatencion.idFamiliar,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_MOTIVOS_SEGUIMIENTO`()
SELECT
...
SELECT idParentesco,detaParentesco FROM `acpsy_parentescofam` ORDER BY idParentesco$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_PERFILES_USUARIO`()
SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_SEGUIMIENTOS`()
SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_SEGUIMIENTOS_F`(IN `_idProfesional` INT(11))
SELECT
acpsy_seguimiento.idSeguimiento,
date_format( acpsy_seguimiento.fRegistrSeg, '%d/%m/%Y' ) AS fRegistrSeg,
acpsy_seguimiento.idAtencionPac,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_SEGUIMIENTOS_FECHAS`(IN `_fechaInicialSeg` DATE, IN `_fechaFinalSeg` DATE, IN `_idProfesional` INT(11))
IF
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_SEXO`()
SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `LISTAR_TIPO_SEGUIMIENTO`()
SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_ATENCION`(IN `_fRegistroAtencion` DATE, IN `_idEpisodio` TEXT, IN `_cuentaAtencion` VARCHAR(20), IN `_historiaAtencion` VARCHAR(20), IN `_idEstadoPacAtencion` INT(11), IN `_fechaPacNacimiento` DATE, IN `_tipdocAtencion` VARCHAR(20), IN `_nrodocAtencion` VARCHAR(15), IN `_apPaternoAtencion` VARCHAR(30), IN `_apMaternoAtencion` VARCHAR(30), IN `_nombAtencion` VARCHAR(30), IN `_fIngresoAtencion` DATE, IN `_servAtencion` VARCHAR(100), IN `_camaAtencion` VARCHAR(20), IN `_distritoAtencion` VARCHAR(100), IN `_edadAtencion` VARCHAR(20), IN `_tipSexoAtencion` INT(11), IN `_financiaAtencion` VARCHAR(50), IN `_idURegAtencion` INT(11))
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_AUDATENCION`(IN `_idAtencion` INT(11), IN `_fechaRegAudi` DATE, IN `_idUsuario` INT(11), IN `_AccRealizada` TEXT, IN `_cuentaAnterior` TEXT, IN `_EpisodioAnterior` TEXT, IN `_cuentaNueva` TEXT, IN `_EpisodioNuevo` TEXT)
INSERT INTO zacpsy_aud_atenciones ( idAtencion, fechaRegAudi, idUsuario, AccRealizada, cuentaAnterior, EpisodioAnterior, cuentaNueva, EpisodioNuevo )
VALUES
	(
		_idAtencion,
		_fechaRegAudi,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_AUDATENCION2`(IN `_idAtencion` INT(11), IN `_fechaRegAudi` DATE, IN `_idUsuario` INT(11), IN `_AccRealizada` TEXT, IN `_cuentaAnterior` TEXT, IN `_EpisodioAnterior` TEXT)
INSERT INTO zacpsy_aud_atenciones (idAtencion, fechaRegAudi, idUsuario, AccRealizada, cuentaAnterior, EpisodioAnterior)
VALUES
	(
		_idAtencion,
		_fechaRegAudi,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_AUDFAMILIAR`(IN `_idFamiliar` INT(11), IN `_fecRegAudi` DATE, IN `_idUsuario` INT(11), IN `_AccRealizada` TEXT, IN `_idAtencionAnt` INT(11), IN `_ndocAnt` VARCHAR(20), IN `_idAtencionNueva` INT(11), IN `_ndocNuevo` VARCHAR(20))
INSERT INTO zacpsy_aud_familiares (idFamiliar,fecRegAudi, idUsuario, AccRealizada, idAtencionAnt, ndocAnt, idAtencionNueva, ndocNuevo )
VALUES
	( _idFamiliar,_fecRegAudi, _idUsuario, _AccRealizada, _idAtencionAnt, _ndocAnt, _idAtencionNueva, _ndocNuevo )$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_AUDFAMILIAR2`(IN `_idFamiliar` INT(11), IN `_fecRegAudi` DATE, IN `_idUsuario` INT(11), IN `_AccRealizada` TEXT, IN `_idAtencionAnt` INT(11), IN `_ndocAnt` VARCHAR(20))
INSERT INTO zacpsy_aud_familiares ( idFamiliar,fecRegAudi, idUsuario, AccRealizada, idAtencionAnt, ndocAnt)
VALUES
	(_idFamiliar,_fecRegAudi, _idUsuario, _AccRealizada, _idAtencionAnt, _ndocAnt)$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_DIAGNOSTICO`(IN `_cieDiagnostico` VARCHAR(20), IN `_detaDiagnostico` VARCHAR(100))
INSERT INTO acpsy_diagnosticos(cieDiagnostico,detaDiagnostico) VALUES(_cieDiagnostico,_detaDiagnostico)$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_FAMILIARES`(IN `_fechaRegistro` DATE, IN `_idUsuario` INT(11), IN `_idAtencion` INT(11), IN `_idParentesco` INT(11), IN `_idTipSexo` INT(11), IN `_tipdocFamiliar` VARCHAR(20), IN `_ndocFamiliar` VARCHAR(20), IN `_nombApFamiliar` VARCHAR(100), IN `_edadFamiliar` VARCHAR(20), IN `_telcelFamiliar` VARCHAR(12))
INSERT INTO acpsy_famatencion ( fechaRegistro, idUsuario, idAtencion, idParentesco, idTipSexo, tipdocFamiliar, ndocFamiliar, nombApFamiliar, edadFamiliar, telcelFamiliar )
VALUES
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_PROFESIONAL`(IN `_idCondicion` INT(11), `_dniProfesional` VARCHAR(15), IN `_cpspProfesional` VARCHAR(25), IN `_apellidosProfesional` VARCHAR(50), IN `_nombresProfesional` VARCHAR(50))
INSERT INTO acpsy_profesionales(idCondicion,dniProfesional,cpspProfesional,apellidosProfesional,nombresProfesional) VALUES(_idCondicion,_dniProfesional,_cpspProfesional,_apellidosProfesional,_nombresProfesional)$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_SEGUIMIENTO`(IN `_fRegistrSeg` DATE, IN `_idUsuario` INT(11), IN `_idAtencionPac` INT(11), IN `_idProfesional` INT(11), IN `_idTipoSeguimiento` INT(11), IN `_idMotSeguimiento` INT(11), IN `_idDiag1Seg` INT(11), IN `_idDiag2Seg` INT(11), IN `_comunFamSeg` VARCHAR(10), IN `_idFamAtSeg` INT(11), IN `_idDiag1SegFam` INT(11), IN `_idDiag2SegFam` INT(11), IN `_obsSeg` VARCHAR(200))
INSERT INTO acpsy_seguimiento (
	fRegistrSeg,
	idUsuario,
	idAtencionPac,
	idProfesional,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRAR_USUARIO`(IN `_idPerfil` INT(11), IN `_dniUsuario` VARCHAR(20), IN `_apellidosUsuario` VARCHAR(50), IN `_nombresUsuario` VARCHAR(50), IN `_cuentaUsuario` VARCHAR(50), IN `_correoUsuario` VARCHAR(50), IN `_claveUsuario` VARCHAR(100))
INSERT INTO acpsy_usuarios ( idPerfil, dniUsuario, apellidosUsuario, nombresUsuario, cuentaUsuario, correoUsuario, claveUsuario )
VALUES
	( _idPerfil, _dniUsuario, _apellidosUsuario, _nombresUsuario, _cuentaUsuario, _correoUsuario, _claveUsuario )$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `REGISTRO_INTENTOS`(IN `_idUsuario` INT(11))
BEGIN
UPDATE acpsy_usuarios SET intentosUsuario = intentosUsuario + 1 WHERE idUsuario = _idUsuario;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `REPORTE_ATEREGANU`(IN `_inicio` VARCHAR(10), IN `_fin` VARCHAR(10))
IF _inicio = "" THEN
	SELECT
	MONTH
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REPORTE_AUDIATENCIONES`(IN `_inicio` VARCHAR(10), IN `_fin` VARCHAR(10))
IF
	_inicio = "" THEN
	SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REPORTE_AUDIFAMILIARES`(IN `_inicio` VARCHAR(10), IN `_fin` VARCHAR(10))
IF _inicio = "" THEN
	SELECT
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REPORTE_PARENTESCO`(IN `_INICIO` VARCHAR(10), IN `_FIN` VARCHAR(10))
IF _INICIO = "" THEN
	SELECT
	COUNT( acpsy_seguimiento.idSeguimiento ) AS CONTEO,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REPORTE_SEGMENSXPROFESIONAL`(IN `_INICIO` VARCHAR(10), IN `_FIN` VARCHAR(10), IN `_PROFESIONAL` INT(11))
IF _INICIO = "" THEN
	SELECT MONTH
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REPORTE_SEGTIPOXPROFESIONAL`(IN `_INICIO` VARCHAR(10), IN `_FIN` VARCHAR(10), IN `_PROFESIONAL` INT(11))
IF _INICIO = "" THEN
	SELECT
		COUNT( acpsy_seguimiento.idSeguimiento ) AS CONTADOR,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REPORTE_SEGUIMIENTOXDIAGFAM`(IN `_INICIO` VARCHAR(10), IN `_FIN` VARCHAR(10), IN `_PROFESIONAL` INT(11))
IF
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REPORTE_SEGUIMIENTOXDIAGPAC`(IN `_INICIO` VARCHAR(10), IN `_FIN` VARCHAR(10), IN `_PROFESIONAL` INT(11))
IF
	( _INICIO = "" AND _PROFESIONAL = 0 ) THEN
SELECT
	COUNT(acpsy_seguimiento.idSeguimiento) AS CONTADOR, 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REPORTE_SEGUIMIENTOXPROFESIONAL`(IN `_INICIO` VARCHAR(10), IN `_FIN` VARCHAR(10), IN `_PROFESIONAL` INT(11))
IF
	( _INICIO = "" AND _PROFESIONAL = 0 ) THEN
	SELECT
		CONCAT( acpsy_profesionales.nombresProfesional, " ", acpsy_profesionales.apellidosProfesional ) AS PROFESIONAL,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REPORTE_SEGUIMIENTOXTIPO`(IN `_INICIO` VARCHAR(10), IN `_FIN` VARCHAR(10), IN `_PROFESIONAL` INT(11))
IF
	( _INICIO = "" AND _PROFESIONAL = 0 ) THEN
	SELECT
		COUNT( acpsy_seguimiento.idSeguimiento ) AS CONTADOR,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REPORTE_SEGUIMIENTO_JEFATURA`(IN `_INICIO` VARCHAR(10), IN `_FIN` VARCHAR(10), IN `_PROFESIONAL` INT(11))
IF
	( _INICIO = "" AND _PROFESIONAL = 0 ) THEN
	SELECT
		acpsy_seguimiento.idSeguimiento,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REPORTE_SEGUIMIENTO_PROFESIONAL`(IN `_INICIO` VARCHAR(10), IN `_FIN` VARCHAR(10), IN `_PROFESIONAL` INT(11))
IF
	( _INICIO = "" ) THEN
	SELECT
		acpsy_seguimiento.idSeguimiento,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REPORTE_SEGUIMREGS`(IN `_INICIO` VARCHAR(10), IN `_FIN` VARCHAR(10))
IF
	_INICIO = "" THEN
	SELECT MONTH
		( acpsy_seguimiento.fRegistrSeg ) AS NMES,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `REPORTE_SEXO`(IN `_INICIO` VARCHAR(10), IN `_FIN` VARCHAR(10))
IF _INICIO = "" THEN
	SELECT
	COUNT( acpsy_seguimiento.idSeguimiento ) AS CONTEO,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `VALIDA_FAMILIAR`(IN `_idAtencion` INT(11), IN `_ndocFamiliar` VARCHAR(20))
SELECT
	acpsy_famatencion.idFamiliar, 
	acpsy_famatencion.idAtencion, 
	acpsy_famatencion.ndocFamiliar
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `VERIFICA_ESTADO_LOG`(IN `_USUARIO` INT(11))
SELECT
	acpsy_usuarios.idUsuario, 
	acpsy_usuarios.idEstado
FROM
...
-- Funciones
--
CREATE DEFINER=`root`@`localhost` FUNCTION `MES_SPANISH`(`_d` DATE, `_locale` VARCHAR(5)) RETURNS varchar(22) CHARSET utf8
BEGIN
...
CREATE TABLE IF NOT EXISTS `acpsy_atencion` (
...
--
DELIMITER $$
CREATE TRIGGER `GENERAR_CORRELATIVO_ATENCION` BEFORE INSERT ON `acpsy_atencion`
 FOR EACH ROW BEGIN
...
CREATE TABLE IF NOT EXISTS `acpsy_condicionprof` (
...
CREATE TABLE IF NOT EXISTS `acpsy_diagnosticos` (
...
CREATE TABLE IF NOT EXISTS `acpsy_estadoatencion` (
...
CREATE TABLE IF NOT EXISTS `acpsy_estadopaciente` (
...
CREATE TABLE IF NOT EXISTS `acpsy_estadoprof` (
...
CREATE TABLE IF NOT EXISTS `acpsy_estadosu` (
...
CREATE TABLE IF NOT EXISTS `acpsy_estatusseguimiento` (
...
CREATE TABLE IF NOT EXISTS `acpsy_famatencion` (
...
CREATE TABLE IF NOT EXISTS `acpsy_motivoseguimiento` (
...
CREATE TABLE IF NOT EXISTS `acpsy_parentescofam` (
...
CREATE TABLE IF NOT EXISTS `acpsy_perfiles` (
...
CREATE TABLE IF NOT EXISTS `acpsy_profesionales` (
...
CREATE TABLE IF NOT EXISTS `acpsy_seguimiento` (
...
) ENGINE=InnoDB AUTO_INCREMENT=1883 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `acpsy_tiposeguimiento` (
  `idTipoSeguimiento` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `acpsy_tipsexo` (
...
CREATE TABLE IF NOT EXISTS `acpsy_usuarios` (
  `idUsuario` int(11) NOT NULL,
  `idPerfil` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zacpsy_aud_atenciones` (
...
CREATE TABLE IF NOT EXISTS `zacpsy_aud_familiares` (
...
--
ALTER TABLE `acpsy_atencion`
  MODIFY `idAtencion` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=510;
--
...
--
ALTER TABLE `acpsy_famatencion`
  MODIFY `idFamiliar` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=497;
--
...
--
ALTER TABLE `acpsy_seguimiento`
  MODIFY `idSeguimiento` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1883;
--
